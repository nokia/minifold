...
from minifold.strings import MAP_TO_INTERNATIONAL, remove_ponctuation, to_international_string, to_canonic_fullname
...
def remove_ponctuation():
    s_in  = "a,,ä;â.à:a a"
    s_out = "a  ä â à a a"
    assert remove_ponctuation(s_in) == s_out

def to_canonic_fullname():
